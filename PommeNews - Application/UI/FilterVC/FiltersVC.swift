...
class FiltersVC: UICollectionViewController {
    ...
    private let supportedThemes = SupportedThemeFilterLoader.shared.supportedThemes
    ...
    public var onSave: (([ArticleTheme]) -> ())?
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.title = supportedThemes[indexPath.row].localized
    ...
    @IBAction func saveFilters(_ sender: Any) {
        ...
        let selectedThemes: [ArticleTheme] = selectedIdx.map({supportedThemes[$0.row]})
